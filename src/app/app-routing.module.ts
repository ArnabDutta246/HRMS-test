...
import { AvaiableServiceService } from './shared/avaiable-service.service';
import { CombineGuardService } from './shared/combine-guard.service';
...
const appRoutes: Routes = [
  ...
  },
  {
    ...
    //canActivateChild: [AvaiableServiceService],
    component: PanelContainerComponent,
    children: [
      {
        path: "dashboard",
      ...
      },
      {
        ...
        canActivateChild: [AuthGuardUserService],
        //canActivateChild: [AvaiableServiceService],
        //canActivateChild:[CombineGuardService],
