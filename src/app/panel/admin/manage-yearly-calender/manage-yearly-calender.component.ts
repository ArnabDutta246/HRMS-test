...
export class ManageYearlyCalenderComponent implements OnInit,OnChanges,AfterViewInit {
  @Input() data: any;
  ...
  constructor(
    ...
    this.allCol.getPlanDataAll().subscribe(res=>{
       console.log(res.payload.data());
       this.planData = res.payload.data();
    });
